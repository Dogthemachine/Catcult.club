...
class Stores(models.Model):
    ...
    image = ResizedImageField(size=[1500, 1500], upload_to="info")
    small_image = ResizedImageField(
        size=[300, 300], crop=["middle", "center"], upload_to="small_info", blank=True
    )
    description = models.TextField(_("description"), blank=True, default="")
    order_is_available = models.PositiveSmallIntegerField(
        _("order is available"), default=0
    )
